...
public class Survey {
	...
	public Survey(User creator, List<Image> images, String title,
	...
	public String toString() {
		return "Survey [id=" + id + ", title=" + title + ", date=" + date + ", type=" + type + ", creator=" + creator
				+ ", rateCategories=" + rateCategories + ", priority=" + priority + ", images=" + images
