...
//		imageList.add(new Image());
//
//		Survey shoes = new Survey(cedric, imageList, "shoes", categories, SurveyType.TopFlop, participants);
//
//		Survey watch = new Survey(cedric, imageList, "watch", categories, SurveyType.Choose, participants);
//
//		Survey watch2 = new Survey(cedric, imageList, "watches", categories, SurveyType.Star, participants);
//
